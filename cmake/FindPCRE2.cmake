...
if(SSPLIT_USE_INTERNAL_PCRE2)
  ...
  if(MSVC)
     set(PCRE2_LIBRARIES 
             ${CMAKE_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}pcre2-8-staticd${CMAKE_STATIC_LIBRARY_SUFFIX}
             ${CMAKE_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}pcre2-posix-staticd${CMAKE_STATIC_LIBRARY_SUFFIX}
     )
  else(MSVC)
